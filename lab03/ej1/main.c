...
int main(int argc, char *argv[]) {
    ...
    //array_dump(array);
    int mmt = min_min_temp(array);
    printf("La minima temperatura minima del año fue de %d\n", mmt);
    
    int temps[YEARS];
    max_max_temp(array, temps);
    printf("La mayor temperatura por año: ");
    year_array_dumps(temps);
    
    int mprecs[YEARS];
    max_prec_month(array, mprecs);
    printf("El mes con mayor precipitaciones por año: ");
    year_array_dumps(mprecs);
